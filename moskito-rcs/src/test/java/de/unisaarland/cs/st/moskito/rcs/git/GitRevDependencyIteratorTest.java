...
public class GitRevDependencyIteratorTest extends MoskitoTest {
	...
	public void testIter() {
		...
		assertEquals(BranchFactory.getMasterBranch(getPersistenceUtil()), branch_19b);
		
		assertFalse(branch_9d6.hasParent());
		assertEquals(BranchFactory.getMasterBranch(getPersistenceUtil()), branch_9d6);
		
		assertFalse(branch_dee.hasParent());
		assertEquals(BranchFactory.getMasterBranch(getPersistenceUtil()), branch_dee);
		
		assertTrue(branch_d23.hasParent());
		assertEquals(branch_ae9, branch_cbc);
		assertEquals(BranchFactory.getMasterBranch(getPersistenceUtil()), branch_d23.getParent());
		
		assertTrue(branch_cbc.hasParent());
		assertEquals(branch_ae9, branch_cbc);
		assertEquals(BranchFactory.getMasterBranch(getPersistenceUtil()), branch_cbc.getParent());
		...
		assertEquals(BranchFactory.getMasterBranch(getPersistenceUtil()), branch_927);
		...
		assertEquals(BranchFactory.getMasterBranch(getPersistenceUtil()), branch_637);
		
		assertFalse(branch_d98.hasParent());
		assertEquals(branch_1ac, branch_d98);
		
		assertFalse(branch_9be.hasParent());
		assertEquals(BranchFactory.getMasterBranch(getPersistenceUtil()), branch_9be);
		
		assertFalse(branch_a92.hasParent());
		assertEquals(branch_1ac, branch_a92);
		
		assertFalse(branch_fe5.hasParent());
		assertEquals(BranchFactory.getMasterBranch(getPersistenceUtil()), branch_fe5);
