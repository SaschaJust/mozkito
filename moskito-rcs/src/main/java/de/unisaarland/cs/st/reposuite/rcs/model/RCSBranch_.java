...
(value=de.unisaarland.cs.st.reposuite.rcs.model.RCSBranch.class)
...
public class RCSBranch_ {
    ...
    public static volatile SingularAttribute<RCSBranch,de.unisaarland.cs.st.reposuite.rcs.model.RCSBranch> parent;
}
