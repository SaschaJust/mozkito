 ...
 * 
 */
package de.unisaarland.cs.st.mozkito.testing.annotation.processors;
...
import de.unisaarland.cs.st.mozkito.exceptions.TestSettingsError;
import de.unisaarland.cs.st.mozkito.testing.annotation.RepositorySetting;
import de.unisaarland.cs.st.mozkito.testing.annotation.RepositorySettings;
import de.unisaarland.cs.st.mozkito.testing.annotation.processors.MoskitoSettingsProcessor;
...
public class RepositorySettingsProcessor implements MoskitoSettingsProcessor {
	...
	/*
	 * (non-Javadoc)
	 * @see de.unisaarland.cs.st.mozkito.testing.annotation.processors.
