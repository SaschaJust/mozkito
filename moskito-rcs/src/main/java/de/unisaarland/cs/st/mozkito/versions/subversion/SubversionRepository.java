 ...
 * 
 */
package de.unisaarland.cs.st.mozkito.versions.subversion;
...
import de.unisaarland.cs.st.mozkito.versions.ProtocolType;
...
import de.unisaarland.cs.st.mozkito.versions.elements.LogIterator;
...
public class SubversionRepository extends Repository {
	...
	/*
	 * (non-Javadoc)
	 * @see de.unisaarland.cs.st.mozkito.versions.Repository#getChangedPaths(java.lang .String)
	 */
