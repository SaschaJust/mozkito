...
import de.unisaarland.cs.st.mozkito.issues.tracker.sourceforge.SourceforgeParser;
import de.unisaarland.cs.st.mozkito.issues.tracker.sourceforge.SourceforgeTracker;
...
public class SourceforgeParserTest {
	...
	public void testIssueParser() throws InvalidParameterException {
		try {
			...
			assertEquals(de.unisaarland.cs.st.mozkito.issues.tracker.elements.Status.CLOSED, parser.getStatus());
