...
import de.unisaarland.cs.st.moskito.bugs.tracker.bugzilla.xml.ResolutionDocument;
 ...
 */
public class ResolutionDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements ResolutionDocument
{
    ...
    public org.apache.xmlbeans.XmlString xgetResolution()
    {
        synchronized (monitor())
        {
            ...
            target = (org.apache.xmlbeans.XmlString)get_store().find_element_user(RESOLUTION$0, 0);
            return target;
        }
    }
    ...
    public void xsetResolution(org.apache.xmlbeans.XmlString resolution)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlString)get_store().add_element_user(RESOLUTION$0);
            }
