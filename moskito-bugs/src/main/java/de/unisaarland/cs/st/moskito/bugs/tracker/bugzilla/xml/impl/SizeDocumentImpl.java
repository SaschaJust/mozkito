...
import de.unisaarland.cs.st.moskito.bugs.tracker.bugzilla.xml.SizeDocument;
 ...
 */
public class SizeDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements SizeDocument
{
    ...
    public org.apache.xmlbeans.XmlString xgetSize()
    {
        synchronized (monitor())
        {
            ...
            target = (org.apache.xmlbeans.XmlString)get_store().find_element_user(SIZE$0, 0);
            return target;
        }
    }
    ...
    public void xsetSize(org.apache.xmlbeans.XmlString size)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlString)get_store().add_element_user(SIZE$0);
            }
            target.set(size);
        }
    }
