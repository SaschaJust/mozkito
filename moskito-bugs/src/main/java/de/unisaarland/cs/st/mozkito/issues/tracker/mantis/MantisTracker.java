...
public class MantisTracker extends Tracker {
	...
	/*
	 * (non-Javadoc)
	 * @see de.unisaarland.cs.st.mozkito.bugs.tracker.Tracker#getParser()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see de.unisaarland.cs.st.mozkito.bugs.tracker.Tracker#getReportLinks()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see de.unisaarland.cs.st.mozkito.bugs.tracker.Tracker#setup(java.net.URI, java.lang.String, java.lang.String)
	 */
	@Override
