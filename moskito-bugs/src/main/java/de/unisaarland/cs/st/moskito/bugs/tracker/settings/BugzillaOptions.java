...
public class BugzillaOptions extends ArgumentSetOptions<Tracker, ArgumentSet<Tracker, BugzillaOptions>> {
	 ...
	 * @param requirements
	 */
	public BugzillaOptions(final ArgumentSet<?, ?> argumentSet, final Requirement requirements) {
		// TODO fix by herzig
		super(argumentSet, "bugzilla", "Configures options for the bugzilla bugtracker.", requirements);
		// PRECONDITIONS
