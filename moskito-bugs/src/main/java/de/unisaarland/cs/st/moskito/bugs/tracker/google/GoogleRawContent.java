...
public class GoogleRawContent extends XmlReport implements Storable {
	 ...
	 * Gets the status.
	 * 
	 * @return the status (Started, Accepted, FixedNotReleased, NeedsInfo, New, PatchesWelcome, ReviewPending,
	 *         AssumedStale, Duplicate, Fixed, Invalid, KnownQuirk, NotPlanned, etc.)
	 */
	 ...
	 * Gets the type.
	 * 
	 * @return the type (Defect, Enhancement, Task, Docs, ---, Feature, Optimization, etc.)
	 */
