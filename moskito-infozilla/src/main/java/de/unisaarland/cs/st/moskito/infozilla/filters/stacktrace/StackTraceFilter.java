...
public abstract class StackTraceFilter extends InfozillaFilter {
	 ...
	 * (non-Javadoc)
	 * @see
	 * de.unisaarland.cs.st.moskito.infozilla.filters.InfozillaFilter#getOutputText()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * @see
	 * de.unisaarland.cs.st.moskito.infozilla.filters.InfozillaFilter#runFilter(java
	 * .lang.String)
	 */
	@Override
