 ...
 ******************************************************************************/
package de.unisaarland.cs.st.mozkito.infozilla.filters.patch;

import java.util.ArrayList;
import java.util.List;

import de.unisaarland.cs.st.mozkito.infozilla.model.patch.Patch;
import de.unisaarland.cs.st.mozkito.infozilla.model.patch.PatchHunk;
import de.unisaarland.cs.st.mozkito.infozilla.model.patch.UnifiedDiff;
...
public class RelaxedPatchParser {
	...
	public List<? extends Patch> parseForPatches(final String text) {
		...
		for (String potentialPatch : indexPartition) {
			...
			UnifiedDiff patch = new UnifiedDiff();
		...
		for (Patch p : foundPatches) {
			UnifiedDiff u = (UnifiedDiff) p;
			int patchStart = text.indexOf(u.getHeader());
			
			int patchEnd = text.lastIndexOf(u.getHunks().get(u.getHunks().size() - 1).getText())
