...
public class PrefixInferenceStrategy extends AbstractInferenceStrategy {
	...
	public PrefixInferenceStrategy(final PPAIndexer indexer, final PPAEngine ppaEngine) {
	...
	private void processOperators(final PrefixExpression node, final TypeFact newFact) {
