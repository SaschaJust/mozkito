...
public class JavaSourceCodeFilter extends SourceCodeFilter {
	...
	/*
	 * (non-Javadoc)
	 * @see de.unisaarland.cs.st.mozkito.infozilla.filters.sourcecode.SourceCodeFilter#getOutputText()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see de.unisaarland.cs.st.mozkito.infozilla.filters.sourcecode.SourceCodeFilter#runFilter(java.lang.String)
	 */
	@Override
