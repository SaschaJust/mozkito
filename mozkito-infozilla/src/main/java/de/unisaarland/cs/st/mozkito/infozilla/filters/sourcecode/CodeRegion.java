...
package de.unisaarland.cs.st.mozkito.infozilla.filters.sourcecode;
 ...
 * @see de.unisaarland.cs.st.mozkito.infozilla.filters.sourcecode.JavaSourceCodeFilter
 * @see de.unisaarland.cs.st.mozkito.infozilla.filters.chain.FilterChain
 * @see de.unisaarland.cs.st.mozkito.infozilla.Ressources.Java_CodeDB.txt
 * @see de.unisaarland.cs.st.mozkito.infozilla.Ressources.Java_Keywords.txt
 */
public class CodeRegion implements Comparable<CodeRegion> {
	 ...
	 * de.unisaarland.cs.st.mozkito.infozilla.Ressources.Java_CodeDB.txt
	 */
