 ...
 *******************************************************************************/
package de.unisaarland.cs.st.mozkito.untangling.blob.combine;
...
public class CombineOperatorTest {
	...
	private class TestObjectCombineOperator implements CombineOperator<TestObject> {
		...
		/*
		 * (non-Javadoc)
		 * @see de.unisaarland.cs.st.mozkito.untangling.blob.CombineOperator#canBeCombined(java.lang.Object,
		 * java.lang.Object)
		 */
		@Override
