 ...
 ******************************************************************************/
package de.unisaarland.cs.st.mozkito.versions;
...
import de.unisaarland.cs.st.mozkito.exceptions.UnregisteredRepositoryTypeException;
import de.unisaarland.cs.st.mozkito.versions.Repository;
import de.unisaarland.cs.st.mozkito.versions.RepositoryFactory;
import de.unisaarland.cs.st.mozkito.versions.RepositoryType;
import de.unisaarland.cs.st.mozkito.versions.cvs.CVSRepository;
import de.unisaarland.cs.st.mozkito.versions.git.GitRepository;
import de.unisaarland.cs.st.mozkito.versions.mercurial.MercurialRepository;
import de.unisaarland.cs.st.mozkito.versions.subversion.SubversionRepository;
