...
public class RCSFileTest {
	...
	public void testGetPath() {
		...
		assertEquals("public.java", rCSFile.getPath(t_0));
		
		rCSFile.assignTransaction(t_4, "new_name.java");
		assertEquals("new_name.java", rCSFile.getPath(t_4));
		assertEquals("public.java", rCSFile.getPath(t_3));
	...
	//@formatter:on
		...
		final RCSTransaction t_2 = new RCSTransaction("2", "", new DateTime(), person, "");
		new RCSRevision(t_2, rCSFile, ChangeType.Modified);
