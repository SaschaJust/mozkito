 ...
 *
 */
public class ScoringTransactionReader extends RepoSuiteSourceThread<RCSTransaction> {
	 ...
	 */
	public ScoringTransactionReader(final RepoSuiteThreadGroup threadGroup, final RepoSuiteSettings settings,
	        final PersistenceUtil persistenceUtil) {
		super(threadGroup, ScoringTransactionReader.class.getSimpleName(), settings);
