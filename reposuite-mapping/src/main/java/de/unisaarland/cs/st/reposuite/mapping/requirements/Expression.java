...
/**
 * The superclass of all {@link Expression}s that are used to express the
 * support of an engine for specific instances of {@link MappableEntity}s.
 * 
...
public abstract class Expression {
	 ...
	 * 
	 * Returns 1 if the criterion is matched. Returns -1 if the criterion is
	 * matched in opposite order, i.e. check(target2, target1) returns 1.
	 * Returns 0 otherwise.
	 * 
	 * @param target1
	...
	/**
	 * Evaluates the criterion in regard to the index {@link Index#ONE} refers
	 * to. This has to be implemented by all extensions of {@link Expression}.
	 * 
	 * @param target1
	 *            the 'from' {@link MappableEntity}
	 * @param target2
