...
public class JavaMethodCall extends JavaElement implements Annotated {
	...
	/*
	 * (non-Javadoc)
	 * @see de.unisaarland.cs.st.mozkito.ppa.model.JavaElement#equals(java.lang .Object)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see de.unisaarland.cs.st.mozkito.ppa.model.JavaElement#getXMLRepresentation ()
	 */
	@Override
	@NoneNull
	@Transient
