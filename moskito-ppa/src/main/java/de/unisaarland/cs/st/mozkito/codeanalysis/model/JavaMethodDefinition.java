...
public class JavaMethodDefinition extends JavaElement implements Annotated, Serializable {
	...
	/*
	 * (non-Javadoc)
	 * @see de.unisaarland.cs.st.mozkito.ppa.model.JavaElementDefinition#equals (java.lang.Object)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see de.unisaarland.cs.st.mozkito.ppa.model.JavaElement#getXMLRepresentation (org.w3c.dom.Document)
	 */
	@Override
	@Transient
	...
	/*
	 * (non-Javadoc)
	 * @see de.unisaarland.cs.st.mozkito.ppa.model.JavaElementDefinition#hashCode()
	 */
	@Override
	public int hashCode() {
		final int prime = 31;
