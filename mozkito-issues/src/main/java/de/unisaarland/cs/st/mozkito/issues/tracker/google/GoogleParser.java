 ...
 *******************************************************************************/
package de.unisaarland.cs.st.mozkito.issues.tracker.google;
...
public class GoogleParser implements Parser {
	...
	/*
	 * (non-Javadoc)
	 * @see de.unisaarland.cs.st.mozkito.bugs.tracker.Parser#getResolution()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see de.unisaarland.cs.st.mozkito.bugs.tracker.Parser#getLastUpdateTimestamp()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see de.unisaarland.cs.st.mozkito.bugs.tracker.Parser#setURI(java.net.URI)
	 */
	@Override
