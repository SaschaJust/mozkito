...
public abstract class BugzillaParser implements Parser {
	...
	/*
	 * (non-Javadoc)
	 * @see de.unisaarland.cs.st.mozkito.bugs.tracker.Tracker#checkRAW(de.unisaarland
	...
	/*
	 * (non-Javadoc)
	 * @see de.unisaarland.cs.st.mozkito.bugs.tracker.Tracker#checkXML(de.unisaarland
	...
	/*
	 * (non-Javadoc)
	 * @see de.unisaarland.cs.st.mozkito.bugs.tracker.Tracker#createDocument(de
	...
	/*
	 * (non-Javadoc)
	 * @see de.unisaarland.cs.st.mozkito.bugs.tracker.Parser#getFetchTime()
	 */
	@Override
