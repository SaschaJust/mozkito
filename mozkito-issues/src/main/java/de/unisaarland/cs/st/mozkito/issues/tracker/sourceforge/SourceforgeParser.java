 ...
 *******************************************************************************/
package de.unisaarland.cs.st.mozkito.issues.tracker.sourceforge;
...
public class SourceforgeParser implements Parser {
	...
	/*
	 * (non-Javadoc)
	 * @see de.unisaarland.cs.st.mozkito.bugs.tracker.Parser#getComments()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see de.unisaarland.cs.st.mozkito.bugs.tracker.Parser#getHistoryElement(int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see de.unisaarland.cs.st.mozkito.bugs.tracker.Parser#getProduct()
	 */
	@Override
