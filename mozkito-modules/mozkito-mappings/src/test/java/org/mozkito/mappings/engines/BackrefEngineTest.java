 ...
 * 
 */
public class BackrefEngineTest extends EngineTest {
	...
	@Fields (both = FieldKey.BODY)
	public void testNeutralScore() throws IOException {
		this.engine.score(this.relation);
		
		assertNotNull(this.relation);
		assertNotNull(this.relation.getFrom().get(FieldKey.AUTHOR));
		assertNotNull(this.relation.getTo().get(FieldKey.AUTHOR));
