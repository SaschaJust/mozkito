 ...
 */
public class SetArgument extends Argument<HashSet<String>, SetArgument.Options> {
	
	/**
	 * The Class Options.
	 */
	public static class Options extends ArgumentOptions<HashSet<String>, SetArgument> {
		...
		public Options(@NotNull final ArgumentSet<?, ?> argumentSet, @NotNull @NotEmptyString final String name,
		        @NotNull @NotEmptyString final String description, final HashSet<String> defaultValue,
