...
import net.ownhero.dev.hiari.settings.requirements.IsSet;
 ...
 * 
 */
public class MailArguments extends ArgumentSet<Properties> {
	 ...
	 */
	public MailArguments(@NotNull final ArgumentSet<?> argumentSet, @NotNull final Requirement requirements)
	        throws ArgumentRegistrationException {
