 ...
 *
 */
public class IntegerDoubleTransformer extends AndamaTransformer<Integer, Double> {
	 ...
	 */
	public IntegerDoubleTransformer(final AndamaGroup threadGroup, final AndamaSettings settings,
	 ...
	 */
	@Override
	public Double process(final Integer data) {
		// TODO Auto-generated method stub
		return null;
	}
