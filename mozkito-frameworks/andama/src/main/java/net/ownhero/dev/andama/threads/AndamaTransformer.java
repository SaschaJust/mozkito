...
/**
 * The {@link AndamaTransformer} class is a component of the {@link AndamaChain}
 * . It takes data from a data source and modifies it. The result is stored as a
 * new instance in the output storage. {@link AndamaTransformer}s have to have
