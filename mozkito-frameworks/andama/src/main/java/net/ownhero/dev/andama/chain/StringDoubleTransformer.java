 ...
 *
 */
public class StringDoubleTransformer extends AndamaTransformer<String, Double> {
	 ...
	 */
	public StringDoubleTransformer(final AndamaGroup threadGroup, final AndamaSettings settings,
	 ...
	 */
	@Override
	public Double process(final String data) {
		// TODO Auto-generated method stub
		return null;
	}
