 ...
 * 
 */
public class LoggerArguments extends ArgumentSet<Boolean> {
	 ...
	 */
	public LoggerArguments(@NotNull final ArgumentSet<?> argumentSet, @NotNull final Requirement requirements)
	        throws ArgumentRegistrationException {
