...
public interface INode<K, V> extends Runnable {
	...
	/**
	 * Adds a new {@link InputHook} to the {@link INode} object. Default hooks should be replaced, if
	 * present.
	 * 
	 * @param hook
	...
	/**
	 * Adds a new {@link OutputHook} to the {@link INode} object. Default hooks should be replaced, if
	 * present.
	 * 
	 * @param hook
	...
	/**
	 * Adds a new {@link PostExecutionHook} to the {@link INode} object. Default hooks should be replaced, if
	 * present.
	 * 
	 * @param hook
	 ...
	 * @return
	 */
	public Class<? extends Node<K, V>> getBaseType();
	...
	/**
	 * Sets the input storage of the object. In case {@link INode#hasInputConnector()} returns false, this
