...
public class MappableReport extends MappableEntity implements Annotated {
	...
	/*
	 * (non-Javadoc)
	 * @see de.unisaarland.cs.st.mozkito.mapping.mappable.MappableEntity#get(de
	...
	/*
	 * (non-Javadoc)
	 * @see de.unisaarland.cs.st.mozkito.mapping.mappable.MappableEntity#getBaseType ()
	 */
	@Override
	@Transient
	...
	/*
	 * (non-Javadoc)
	 * @see de.unisaarland.cs.st.mozkito.mapping.mappable.model.MappableEntity#getId()
	 */
	@Override
	public String getId() {
	...
	/*
	 * (non-Javadoc)
	 * @see de.unisaarland.cs.st.mozkito.mapping.mappable.MappableEntity#getText()
	 */
	@Override
	@Transient
	...
	/*
	 * (non-Javadoc)
	 * @see de.unisaarland.cs.st.mozkito.mapping.mappable.MappableEntity#supported ()
	 */
