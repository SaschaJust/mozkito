 ...
 ******************************************************************************/
package de.unisaarland.cs.st.mozkito.mappings.filters;
...
import de.unisaarland.cs.st.mozkito.issues.tracker.model.EnhancedReport;
import de.unisaarland.cs.st.mozkito.issues.tracker.settings.Messages;
...
public class ReportFieldFilter extends Filter {
	...
	/*
	 * (non-Javadoc)
	 * @see de.unisaarland.cs.st.mozkito.mapping.filters.MappingFilter#filter(de
	...
	/*
	 * (non-Javadoc)
	 * @see de.unisaarland.cs.st.mozkito.mapping.filters.MappingFilter#getDescription ()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see de.unisaarland.cs.st.mozkito.mapping.filters.MappingFilter#supported()
	 */
	@Override
