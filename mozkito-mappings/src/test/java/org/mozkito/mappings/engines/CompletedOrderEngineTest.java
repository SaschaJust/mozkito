...
public class CompletedOrderEngineTest extends DatabaseTest {
	...
	public static void setUpBeforeClass() throws Exception {
		CompletedOrderEngineTest.finder = Environment.setup("/engines.codeFragments.test.properties");
	...
	private Relation score(final String transactionId,
		...
		CompletedOrderEngineTest.finder.score(this.engine, relation);
	...
	@Before
	public void setUp() {
		this.engines = CompletedOrderEngineTest.finder.getEngines();
