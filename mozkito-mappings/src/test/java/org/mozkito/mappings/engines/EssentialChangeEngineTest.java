...
public class EssentialChangeEngineTest extends DatabaseTest {
	...
	public static void setUpBeforeClass() throws Exception {
		EssentialChangeEngineTest.finder = Environment.setup("/engines.codeFragments.test.properties");
	...
	private Relation score(final String transactionId,
		...
		EssentialChangeEngineTest.finder.score(this.engine, relation);
	...
	@Before
	public void setUp() {
		this.engines = EssentialChangeEngineTest.finder.getEngines();
