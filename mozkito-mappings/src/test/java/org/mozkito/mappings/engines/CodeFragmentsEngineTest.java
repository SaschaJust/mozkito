...
public class CodeFragmentsEngineTest extends DatabaseTest {
	...
	public static void setUpBeforeClass() throws Exception {
		CodeFragmentsEngineTest.finder = Environment.setup("/engines.codeFragments.test.properties");
	...
	private Relation score(final String transactionId,
		...
		CodeFragmentsEngineTest.finder.score(this.engine, relation);
	...
	@Before
	public void setUp() {
		this.engines = CodeFragmentsEngineTest.finder.getEngines();
