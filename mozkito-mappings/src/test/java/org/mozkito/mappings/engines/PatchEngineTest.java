...
public class PatchEngineTest extends DatabaseTest {
	...
	public static void setUpBeforeClass() throws Exception {
		PatchEngineTest.finder = Environment.setup("/engines.codeFragments.test.properties");
	...
	private Relation score(final String transactionId,
		...
		PatchEngineTest.finder.score(this.engine, relation);
	...
	@Before
	public void setUp() {
		this.engines = PatchEngineTest.finder.getEngines();
