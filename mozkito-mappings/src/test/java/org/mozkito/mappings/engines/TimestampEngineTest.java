...
public class TimestampEngineTest extends DatabaseTest {
	...
	public static void setUpBeforeClass() throws Exception {
		TimestampEngineTest.finder = Environment.setup("/engines.codeFragments.test.properties");
	...
	private Relation score(final String transactionId,
		...
		TimestampEngineTest.finder.score(this.engine, relation);
	...
	@Before
	public void setUp() {
		this.engines = TimestampEngineTest.finder.getEngines();
