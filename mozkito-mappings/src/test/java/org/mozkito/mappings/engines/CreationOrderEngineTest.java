...
public class CreationOrderEngineTest extends DatabaseTest {
	...
	public static void setUpBeforeClass() throws Exception {
		CreationOrderEngineTest.finder = Environment.setup("/engines.codeFragments.test.properties");
	...
	private Relation score(final String transactionId,
		...
		CreationOrderEngineTest.finder.score(this.engine, relation);
	...
	@Before
	public void setUp() {
		this.engines = CreationOrderEngineTest.finder.getEngines();
