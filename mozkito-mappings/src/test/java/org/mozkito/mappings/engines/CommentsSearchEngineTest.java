...
public class CommentsSearchEngineTest extends DatabaseTest {
	...
	public static void setUpBeforeClass() throws Exception {
		CommentsSearchEngineTest.finder = Environment.setup("/engines.codeFragments.test.properties");
	...
	private Relation score(final String transactionId,
		...
		CommentsSearchEngineTest.finder.score(this.engine, relation);
	...
	@Before
	public void setUp() {
		this.engines = CommentsSearchEngineTest.finder.getEngines();
