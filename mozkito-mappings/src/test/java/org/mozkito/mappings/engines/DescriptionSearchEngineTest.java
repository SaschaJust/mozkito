...
public class DescriptionSearchEngineTest extends DatabaseTest {
	...
	public static void setUpBeforeClass() throws Exception {
		DescriptionSearchEngineTest.finder = Environment.setup("/engines.codeFragments.test.properties");
	...
	private Relation score(final String transactionId,
		...
		DescriptionSearchEngineTest.finder.score(this.engine, relation);
	...
	@Before
	public void setUp() {
		this.engines = DescriptionSearchEngineTest.finder.getEngines();
