...
/**
 * The Class MethodModificationEngineTest.
 * 
 * @author Sascha Just <sascha.just@mozkito.org>
 */
@DatabaseSettings (unit = "mappings", database = "moskito_jruby_july2010", options = ConnectOptions.CREATE)
public class MethodModificationEngineTest extends DatabaseTest {
	...
	public static void setUpBeforeClass() throws Exception {
		MethodModificationEngineTest.finder = Environment.setup("/engines.codeFragments.test.properties");
	...
	private Relation score(final String transactionId,
		...
		MethodModificationEngineTest.finder.score(this.engine, relation);
	...
	@Before
	public void setUp() {
		this.engines = MethodModificationEngineTest.finder.getEngines();
