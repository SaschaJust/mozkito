 ...
 ******************************************************************************/
package de.unisaarland.cs.st.mozkito.mappings.engines;
...
import de.unisaarland.cs.st.mozkito.issues.tracker.model.History;
...
import de.unisaarland.cs.st.mozkito.mappings.mappable.FieldKey;
...
import de.unisaarland.cs.st.mozkito.mappings.requirements.And;
import de.unisaarland.cs.st.mozkito.mappings.requirements.Atom;
import de.unisaarland.cs.st.mozkito.mappings.requirements.Expression;
import de.unisaarland.cs.st.mozkito.mappings.requirements.Index;
import de.unisaarland.cs.st.mozkito.persistence.model.EnumTuple;
...
public class TimestampEngine extends MappingEngine {
	...
	/*
	 * (non-Javadoc)
	 * @see de.unisaarland.cs.st.mozkito.mapping.register.Node#getDescription()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see de.unisaarland.cs.st.mozkito.mappings.engines.MappingEngine#score(de
	 * .unisaarland.cs.st.reposuite.mapping.mappable.MappableEntity,
	 * de.unisaarland.cs.st.mozkito.mapping.mappable.MappableEntity, de.unisaarland.cs.st.mozkito.mapping.model.Mapping)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see de.unisaarland.cs.st.mozkito.mappings.engines.MappingEngine#supported()
	 */
	@Override
