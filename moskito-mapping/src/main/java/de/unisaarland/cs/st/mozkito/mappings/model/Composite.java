...
public class Composite implements Annotated, IComposite {
	...
	/* (non-Javadoc)
     * @see de.unisaarland.cs.st.mozkito.mapping.model.IComposite#addStrategy(java.lang.String, java.lang.Boolean)
     */
	@Override
    @Transient
	...
	/* (non-Javadoc)
     * @see de.unisaarland.cs.st.mozkito.mapping.model.IComposite#getFrom()
     */
	@Override
	...
	/* (non-Javadoc)
     * @see de.unisaarland.cs.st.mozkito.mapping.model.IComposite#getHandle()
     */
	@Override
	...
	/* (non-Javadoc)
     * @see de.unisaarland.cs.st.mozkito.mapping.model.IComposite#getRelation()
     */
	@Override
	...
	/* (non-Javadoc)
     * @see de.unisaarland.cs.st.mozkito.mapping.model.IComposite#getStrategies()
     */
	@Override
	...
	/* (non-Javadoc)
     * @see de.unisaarland.cs.st.mozkito.mapping.model.IComposite#getTo()
     */
	@Override
