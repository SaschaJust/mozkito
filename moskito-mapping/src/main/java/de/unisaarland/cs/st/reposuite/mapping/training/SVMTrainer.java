...
public class SVMTrainer extends MappingTrainer {
	...
	private void do_cross_validation() {
		...
		if ((this.param.svm_type == svm_parameter.EPSILON_SVR) || (this.param.svm_type == svm_parameter.NU_SVR)) {
			...
			System.out.print("Cross Validation Squared correlation coefficient = "
			        + ((((this.prob.l * sumvy) - (sumv * sumy)) * ((this.prob.l * sumvy) - (sumv * sumy))) / (((this.prob.l * sumvv) - (sumv * sumv)) * ((this.prob.l * sumyy) - (sumy * sumy))))
			        + "\n");
		} else {
			for (i = 0; i < this.prob.l; i++) {
	 ...
	 * (non-Javadoc)
	 * @see
	 * de.unisaarland.cs.st.reposuite.mapping.training.MappingTrainer#train()
	 */
	@Override
	public void train() {
		// TODO Auto-generated method stub
