...
public class ReportRegexSelector extends Selector {
	...
	/*
	 * (non-Javadoc)
	 * @see de.unisaarland.cs.st.mozkito.mappings.selectors.MappingSelector# getDescription()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see de.unisaarland.cs.st.mozkito.mappings.selectors.MappingSelector#parse (java.lang.Object)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see de.unisaarland.cs.st.mozkito.mappings.selectors.MappingSelector#supports (java.lang.Class, java.lang.Class)
	 */
	@Override
