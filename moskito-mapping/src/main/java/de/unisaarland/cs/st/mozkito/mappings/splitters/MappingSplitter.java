 ...
 **********************************************************************************************************************/
package de.unisaarland.cs.st.mozkito.mappings.splitters;
...
import de.unisaarland.cs.st.mozkito.mappings.engines.Messages;
...
public abstract class MappingSplitter extends Node {
	...
	/*
	 * (non-Javadoc)
	 * @see de.unisaarland.cs.st.mozkito.mapping.register.Registered#getDescription ()
	 */
	@Override
