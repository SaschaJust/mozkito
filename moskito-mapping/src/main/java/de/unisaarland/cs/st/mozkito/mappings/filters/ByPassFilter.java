...
import de.unisaarland.cs.st.mozkito.mappings.requirements.ByPass;
...
public class ByPassFilter extends Filter {
	 ...
	 * (non-Javadoc)
	 * @see
	 * de.unisaarland.cs.st.mozkito.mapping.filters.Filter#filter(de.unisaarland.cs.st.mozkito.mapping.model.Composite,
	 * java.util.Set)
	 */
	@Override
