 ...
 */
public class CTLConjunction extends CTLBilateralFormula {
	...
	public static CTLConjunction getFromXMLRepresentation(final Element element) {
		assert "CTL-and".equals(element.getNodeName());
		...
		return CTLConjunction.get(left, right);
	}
	...
	/**
	 * Returns the left hand-side of this formula. Specifically, for (f and g) returns f.
	 * 
	...
	/**
	 * Returns the right hand-side of this formula. Specifically, for (f and g) returns g.
	 * 
