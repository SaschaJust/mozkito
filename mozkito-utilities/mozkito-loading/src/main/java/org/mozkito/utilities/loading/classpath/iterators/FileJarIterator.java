...
import org.mozkito.utilities.loading.classpath.ClassPath.ElementIterator;
...
public class FileJarIterator implements ElementIterator {
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.mozkito.utilities.loading.classpath.ClassPath.ElementIterator#loadResource(org.mozkito.utilities.loading.classpath.ClassPath.Element)
	 */
	@Override
