...
public class Resource extends Element {
	...
	public Resource(final String name, final String path,
	        final org.mozkito.utilities.loading.classpath.ClassPath.Element.Type type, final Source source,
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.mozkito.utilities.loading.classpath.ClassPath.Element#load()
	 */
	@Override
