...
public class MaxCollapseVisitor<T> implements MultilevelClusteringCollapseVisitor<T> {
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.mozkito.utilities.clustering.MultilevelClusteringCollapseVisitor#getScore(org.mozkito.utilities.clustering.Cluster,
	 *      org.mozkito.utilities.clustering.Cluster, java.util.Map)
	 */
	@Override
