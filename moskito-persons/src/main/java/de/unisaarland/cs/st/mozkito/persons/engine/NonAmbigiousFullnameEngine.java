...
public class NonAmbigiousFullnameEngine extends MergingEngine {
	...
	/*
	 * (non-Javadoc)
	 * @see de.unisaarland.cs.st.mozkito.persons.engine.MergingEngine#collides(
	 * de.unisaarland.cs.st.mozkito.persistence.model.Person,
	 * de.unisaarland.cs.st.mozkito.persistence.model.PersonContainer,
	 * de.unisaarland.cs.st.mozkito.persons.processing.PersonManager, java.util.Map)
	 */
	@Override
