...
public class UniversalStructuralHolesMetrics<T> {
	...
	public Collection<GenealogyMetricValue> handle(T node) {
		...
		result.add(new GenealogyMetricValue(aggregateConstraintName, nodeId, structuralHoles.aggregateConstraint(node)));
		...
		result.add(new GenealogyMetricValue(EfficiencyName, nodeId, structuralHoles.efficiency(node)));
