...
public class TransactionParentsMetrics extends GenealogyTransactionMetric {
	
	
	private UniversalParentsMetrics<RCSTransaction> universalMetric;
	
	public TransactionParentsMetrics(AndamaGroup threadGroup, AndamaSettings settings,
