...
public class PartitionPageRankMetric extends GenealogyPartitionMetric {
	...
	private final UniversalPageRankMetric<ChangeGenealogyLayerNode> universalMetric;
	 ...
	 *            the genealogy
	 */
	public PartitionPageRankMetric(final PartitionChangeGenealogy genealogy) {
		super(genealogy);
		this.universalMetric = new UniversalPageRankMetric<ChangeGenealogyLayerNode>(genealogy);
	}
