...
import de.unisaarland.cs.st.mozkito.genealogies.metrics.layer.universal.UniversalInbreedMetrics;
...
public class PartitionInbreedMetrics extends GenealogyPartitionMetric {
	...
	private final UniversalInbreedMetrics<ChangeGenealogyLayerNode> universalMetric;
	 ...
	 *            the genealogy
	 */
	public PartitionInbreedMetrics(final PartitionChangeGenealogy genealogy) {
		super(genealogy);
		this.universalMetric = new UniversalInbreedMetrics<ChangeGenealogyLayerNode>(genealogy);
	}
