...
import de.unisaarland.cs.st.mozkito.genealogies.metrics.layer.universal.UniversalParentAgeMetrics;
...
public class PartitionParentAgeMetrics extends GenealogyPartitionMetric implements
	...
	private final UniversalParentAgeMetrics<ChangeGenealogyLayerNode> universalMetric;
	
	/**
	 * Instantiates a new partition parent age metrics.
	 * 
	 * @param genealogy
	 *            the genealogy
	 */
	public PartitionParentAgeMetrics(final PartitionChangeGenealogy genealogy) {
		super(genealogy);
		this.universalMetric = new UniversalParentAgeMetrics<ChangeGenealogyLayerNode>(genealogy, this);
	}
