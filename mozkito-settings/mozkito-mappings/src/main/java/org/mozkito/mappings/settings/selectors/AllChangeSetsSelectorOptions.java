...
import org.mozkito.mappings.selectors.AllChangeSetsSelector;

/**
 * @author Sascha Just <sascha.just@mozkito.org>
 * 
 */
public class AllChangeSetsSelectorOptions extends
        ArgumentSetOptions<AllChangeSetsSelector, ArgumentSet<AllChangeSetsSelector, AllChangeSetsSelectorOptions>> {
	 ...
	 *            the requirements
	 */
	public AllChangeSetsSelectorOptions(final ArgumentSet<?, ?> argumentSet, final Requirement requirements) {
	...
	public AllChangeSetsSelector init() {
		...
		try {
			...
			final AllChangeSetsSelector selector = new AllChangeSetsSelector(tag);
