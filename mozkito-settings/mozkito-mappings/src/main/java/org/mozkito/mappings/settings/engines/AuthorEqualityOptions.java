 ...
 * The Class Options.
 */
public final class AuthorEqualityOptions extends
        ArgumentSetOptions<AuthorEqualityEngine, ArgumentSet<AuthorEqualityEngine, AuthorEqualityOptions>> {
	 ...
	 *            the requirements
	 */
	public AuthorEqualityOptions(final ArgumentSet<?, ?> argumentSet, final Requirement requirements) {
	...
	public Map<String, IOptions<?, ?>> requirements(final ArgumentSet<?, ?> argumentSet) throws ArgumentRegistrationException,
		...
		try {
			...
			this.confidenceOption = new DoubleArgument.Options(
			                                                   ...
			                                                   AuthorEqualityEngine.DEFAULT_CONFIDENCE,
