 ...
 * The Class Options.
 */
public final class LuceneStorageOptions extends
        ArgumentSetOptions<LuceneStorage, ArgumentSet<LuceneStorage, LuceneStorageOptions>> {
	 ...
	 *            the requirements
	 */
	public LuceneStorageOptions(final ArgumentSet<?, ?> argumentSet, final Requirement requirements) {
