...
import org.mozkito.mappings.engines.MethodModificationEngine;
 ...
 * 
 */
public class MethodModificationOptions extends
        ArgumentSetOptions<MethodModificationEngine, ArgumentSet<MethodModificationEngine, MethodModificationOptions>> {
	 ...
	 *            the requirements
	 */
	public MethodModificationOptions(final ArgumentSet<?, ?> argumentSet, final Requirement requirements) {
	...
	public Map<String, IOptions<?, ?>> requirements(final ArgumentSet<?, ?> argumentSet) throws ArgumentRegistrationException,
		...
		try {
			...
			this.confidenceOption = new DoubleArgument.Options(
			                                                   ...
			                                                   MethodModificationEngine.DEFAULT_CONFIDENCE,
