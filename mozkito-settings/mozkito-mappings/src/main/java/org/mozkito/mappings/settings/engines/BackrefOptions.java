 ...
 * The Class Options.
 */
public final class BackrefOptions extends
        ArgumentSetOptions<BackrefEngine, ArgumentSet<BackrefEngine, BackrefOptions>> {
	 ...
	 *            the requirements
	 */
	public BackrefOptions(final ArgumentSet<?, ?> argumentSet, final Requirement requirements) {
	...
	public Map<String, IOptions<?, ?>> requirements(final ArgumentSet<?, ?> argumentSet) throws ArgumentRegistrationException,
		...
		try {
			...
			this.confidenceOption = new DoubleArgument.Options(
			                                                   ...
			                                                   BackrefEngine.DEFAULT_CONFIDENCE, Requirement.required);
