 ...
 */
public class CommentsManagerOptions extends
        ArgumentSetOptions<InlineManager, ArgumentSet<InlineManager, CommentsManagerOptions>> {
	 ...
	 *            the requirements
	 */
	public CommentsManagerOptions(final ArgumentSet<?, ?> argumentSet, final Requirement requirements) {
