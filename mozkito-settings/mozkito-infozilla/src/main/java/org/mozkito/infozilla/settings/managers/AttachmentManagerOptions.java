 ...
 */
public class AttachmentManagerOptions extends
        ArgumentSetOptions<AttachmentManager, ArgumentSet<AttachmentManager, AttachmentManagerOptions>> {
	 ...
	 *            the requirements
	 */
	public AttachmentManagerOptions(final ArgumentSet<?, ?> argumentSet, final Requirement requirements) {
