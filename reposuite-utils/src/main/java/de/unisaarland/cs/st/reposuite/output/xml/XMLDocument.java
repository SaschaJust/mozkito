 ...
 * 
 */
package de.unisaarland.cs.st.reposuite.output.xml;
 ...
 *
 */
public class XMLDocument implements TextSink {
	 ...
	 * (non-Javadoc)
	 * @see
	 * de.unisaarland.cs.st.reposuite.output.TextSink#print(java.lang.String)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * @see
	 * de.unisaarland.cs.st.reposuite.output.TextSink#printLine(java.lang.String
	 * )
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * @see
	 * de.unisaarland.cs.st.reposuite.output.TextSink#printTable(de.unisaarland
	 * .cs.st.reposuite.output.nodes.Table)
	 */
	@Override
