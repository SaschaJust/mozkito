 ...
 */
public class ChangeCouplingRuleFactory_MozkitoTest extends MoskitoTest {
	...
	public static void beforeClass() {
		try {
			...
			final URL sqlURL = ChangeCouplingRuleFactory_MozkitoTest.class.getResource(FileUtils.fileSeparator
