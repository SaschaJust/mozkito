...
public class CoreDependantsMetrics extends GenealogyCoreMetric {
	...
	/**
	 * Instantiates a new core dependants metrics.
	 * 
	 * @param genealogy
	 *            the genealogy
	 */
	public CoreDependantsMetrics(final CoreChangeGenealogy genealogy) {
		super(genealogy);
		this.universalMetric = new UniversalAncestorMetrics<JavaChangeOperation>(genealogy);
	}
