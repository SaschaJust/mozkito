...
public class CTLConjunction extends CTLBilateralFormula {
	 ...
	 */
	public static CTLConjunction get(CTLFormula f, CTLFormula g) {
	...
	/**
	 * Returns the left hand-side of this formula. Specifically, for (f and g)
	 * returns f.
	 * 
	...
	/**
	 * Returns the right hand-side of this formula. Specifically, for (f and g)
	 * returns g.
	 * 
