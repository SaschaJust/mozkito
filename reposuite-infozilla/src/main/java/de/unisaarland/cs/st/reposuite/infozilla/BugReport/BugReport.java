...
public class BugReport implements Comparable<BugReport> {
	...
	private Discussion       discussion;              // have a priority queue
													   // of discussion articles
													   // ordered by Timestamp
	private List<Attachment> attachments;             // have a list of
													   // attachements
	 ...
	 */
	public BugReport(int bug_id, String product_id, String component_id, String priority, String assigned_to,
	        String bug_severity, String bug_status, Timestamp creation_ts, String short_desc, String resolution,
	...
	public String getDiscussionText() {
		...
		for (Message m : discussion.getMessages()) {
			discussionText = discussionText + m.getText() + System.getProperty("line.separator")
	...
	public String getInitialMessageText() {
		String messageText = "";
		if (discussion.getMessages().size() > 0) messageText = discussion.getMessages().get(0).getText();
