...
public class FilterChainEclipse implements FilterChain {
	...
	public FilterChainEclipse(final String inputText) {
		this.unifiedDiffPatchFilter = new UnifiedDiffPatchFilter();
		this.stacktraceFilter = new JavaStackTraceFilter();
		this.sourcecodeFilter = new JavaSourceCodeFilter(FilterChain.class.getResource("Java_CodeDB.txt"));
	...
	public FilterChainEclipse(final String inputText, final boolean runPatches, final boolean runTraces,
