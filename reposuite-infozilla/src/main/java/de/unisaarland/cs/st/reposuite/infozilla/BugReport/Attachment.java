...
public class Attachment {
	...
	private static Set<String> texttypes      = new LinkedHashSet<String>(
	                                                                      java.util.Arrays.asList("application/text",
	                                                                                              "text/*",
	                                                                                              "text/bash-script",
	                                                                                              "text/css",
	                                                                                              "text/csv",
	...
	// Need Magic Types from UNIX file util since values returned by Database
	// tend to be wrong!
	private static Set<String> magictexttypes = new LinkedHashSet<String>(java.util.Arrays.asList("text/html",
	                                                                                              "text/plain",
	                                                                                              "text/plain\0118bit",
	                                                                                              "text/troff",
	                                                                                              "text/x-asm",
	...
	private static Set<String> imagetypes      = new LinkedHashSet<String>(
	                                                                       java.util.Arrays.asList("application/gif",
	                                                                                               "application/jpg",
	                                                                                               "application/pdf",
	                                                                                               "application/png",
	...
	private static Set<String> magicimagetypes = new LinkedHashSet<String>(
	                                                                       java.util.Arrays.asList("application/x-shockwave-flash",
	                                                                                               "image/gif",
	                                                                                               "image/jpeg",
	                                                                                               "image/png",
	                                                                                               "image/tiff",
	                                                                                               ...
	                                                                                               "image/x-photoshop",
	                                                                                               "image/x-portable-bitmap",
	                                                                                               "image/x-portable-bitmap\0117bit",
	                                                                                               "image/x-xpmi",
	                                                                                               "video/quicktime",
	                                                                                               "video/unknown",
	                                                                                               "video/x-msvideo"));
	 ...
	 */
	public Attachment(String description, String mimetype, String filename, Timestamp creation_ts, String type,
	...
	public boolean guessType() {
		...
		if (mimetype.contains("image") || mimetype.contains("jpg") || mimetype.contains("gif")
		        || mimetype.contains("jpeg") || mimetype.contains("bmp") || mimetype.contains("png")
		        || mimetype.contains("video") || description.toLowerCase().contains("screenshot")
		        || filename.toLowerCase().contains("screenshot")) guessedType = "SCREENSHOT";
		
		// Rules for Patches
		if (mimetype.contains("patch") || mimetype.contains("diff") || description.toLowerCase().contains("patch")
		        || description.toLowerCase().contains("diff") || filename.toLowerCase().contains("patch")
		        || filename.toLowerCase().contains("diff")) guessedType = "PATCH";
		
		// Rules for Source Code
		if (mimetype.contains("text/java") || mimetype.contains("text/java source") || mimetype.contains("text/x-java")
		        || mimetype.contains("text/x-java source")
		        || (description.toLowerCase().contains("source") && description.toLowerCase().contains("code"))
		        || filename.toLowerCase().contains(".java")) guessedType = "SOURCECODE";
		
		// Rules for Stack Traces
		if (mimetype.contains("text/log") || mimetype.contains("text/x-log")
		        || (description.toLowerCase().contains("stack") && description.toLowerCase().contains("trace"))
		        || filename.toLowerCase().contains("stacktrace")) guessedType = "STACKTRACE";
